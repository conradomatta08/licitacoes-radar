...
function lerFiltros(sp: URLSearchParams) {
  return {
    ...
    fabricante: sp.get("fabricante") ?? undefined,
    ufFornecedor: sp.get("ufFornecedor") ?? undefined,
    ufOrgao: sp.get("ufOrgao") ?? undefined,
...
const COLUNAS_EXPORT: { titulo: string; valor: (l: ResultadoLinha) => string | number }[] = [
  ...
  { titulo: "Tipo", valor: (l) => (l.material_ou_servico === "M" ? "Material" : l.material_ou_servico === "S" ? "Serviço" : "") },
